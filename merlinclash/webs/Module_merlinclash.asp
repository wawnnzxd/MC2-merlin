	...
	function initializeFormData() {
		...
		"merlinclash_ipt_proxyrouter_sw","merlinclash_ipt_proxyiot_sw","merlinclash_dns_proxydns_sw",
	...
	function get_dbus_data() {
		$.ajax({
			...
			success: function(data) {
				...
				//notice_show(); // MC2-merlin: 不拉取在线公告/广告(也省去对 raw.githubusercontent.com 的跨域请求)
			}
		});
	}
...
<body id="app" skin='ASUSWRT' onload="init();"><!-- MC2-merlin: 固定梅林风格,不跟随固件 sc_skin;想跟随固件改回 <% nvram_get("sc_skin"); %> -->
														...
														<table style="margin:10px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
															<thead>
																...
																<div id="tablet_7" style="display: none;">
																	<div id="merlinclash-OPLOG" style="margin:-1px 0px 0px 0px;">
																		<table style="margin:-1px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" >
																			<thead>
																				<tr>
